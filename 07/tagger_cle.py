...
class Model(tf.keras.Model):
    ...
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        if args.rnn_cell == "LSTM":
            bidirectional = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(args.rnn_cell_dim, return_sequences=True), merge_mode='sum')(concat)
        elif args.rnn_cell == "GRU":
            bidirectional = tf.keras.layers.Bidirectional(tf.keras.layers.GRU(args.rnn_cell_dim, return_sequences=False), merge_mode='sum')(concat)
