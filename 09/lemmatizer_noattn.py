...
parser.add_argument("--cle_dim", default=24, type=int, help="CLE embedding dimension.")
...
parser.add_argument("--rnn_dim", default=24, type=int, help="RNN cell dimension.")
...
class Model(tf.keras.Model):
    ...
    def call(self, inputs, targets=None):
        ...
        sources_states = self.source_rnn(embed)
        ...
        if targets is not None:
            ...
            output, _, output_lens = DecoderTraining([sources_states, target_charseqs])
            #raise NotImplementedError()
        else:
            ...
            output, _, output_lens = DecoderPrediction(sources_states)
            output_lens -= 1
            #raise NotImplementedError()
