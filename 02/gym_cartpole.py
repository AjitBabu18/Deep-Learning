...
def main(args):
    ...
    if not args.evaluate:
        ...
        #hl1 = tf.keras.layers.Dense(1, activation=tf.nn.relu, name="hidden_layer1")
        #hidden_layer = tf.keras.layers.Dense(2, activation=tf.nn.relu, name="hidden_layer2")
        #model = tf.keras.layers.Dense(hidden_layer,  activation=None, name="model")
        model.add(tf.keras.layers.Dense(4, activation="sigmoid", name="layer1"))
        model.add(tf.keras.layers.Dense(7, activation="relu", name="layer2"))
        model.add(tf.keras.layers.Dense(2, activation="softmax", name="layer3"))
